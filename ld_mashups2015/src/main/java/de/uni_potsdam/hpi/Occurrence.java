...
public class Occurrence {
    ...
    public Response getCoordinates(@QueryParam("longitude") double longitude, @QueryParam("latitude") double latitude) {
        ...
        String content = ("<!DOCTYPE html>\n" +
                ...
                "</head>\n" +
                "<body>\n" +
                "<h1>" + occurrence.getSpecies().getScientificName() + "</h1>" +
                ...
                "</body>\n" +
                "</html>");
        return Response.ok(content3).header("Access-Control-Allow-Origin", "http://localhost:63342").build();
    }
}